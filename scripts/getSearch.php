...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    $search->name = htmlspecialchars($row["name"]);
    $search->country = htmlspecialchars($row["country"]);
    $search->albumid = (int) $row["albumid"];
    $search->released = (int) $row["released"];
    $search->title = htmlspecialchars($row["title"]);
    $search->disccount = (int) $row["disccount"];
    $search->format = htmlspecialchars($row["format"]);
    $time = formattime($row["playingtime"]);
    $search->playingtime = $time;
    $search->genre = htmlspecialchars($row["genre"]);
